...
from flows.tech.stages.prompts.slugs import competency_tokens, name_tokens, slugify

logger = logging.getLogger("prompt_generator")

# ``.parent.parent.parent`` because this module lives at
# ``generators/prompts/input_files.py`` after Phase 2 — bumps up to repo root.
