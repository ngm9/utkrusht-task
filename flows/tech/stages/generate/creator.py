...
from flows.tech.stages.generate.tour import build_tour_meta, generate_tour
from flows.tech.stages.generate.trace_check import check_trace_consistency
from flows.tech.stages.generate.repository import (
    TaskValidationError,
    insert_task_competencies,
    validate_task,
)
from flows.tech.stages.generate.persistence import (
    GITHUB_GIST_TOKEN,
...
def create_task(
    ...
    try:
        if scenarios_file is None:
            scenarios_file = (
                Path(__file__).parents[4] / "utilities"
        ...
        from flows.tech.stages.scenarios.prompts import is_agent_competency
