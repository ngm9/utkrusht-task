...
Usage:
    python -m flows.tech.stages.input_files --name "Java" --proficiency BASIC
    python -m flows.tech.stages.input_files --name "Java, Kafka" --proficiency BASIC --dry-run
"""

from flows.tech.stages.input_files.generator import generate_input_files
