...
from flows.pr_review.schemas import BASE_REPO_SCHEMA, PR_GENERATION_SCHEMA
from flows.pr_review.prompts.base_repo_prompts import (
    BASE_REPO_SYSTEM_PROMPT,
    BASE_REPO_GENERATION_PROMPT,
    EVAL_FEEDBACK_BLOCK,
    EVAL_FEEDBACK_BLOCK_EMPTY,
)
from flows.pr_review.prompts.pr_generation_prompts import (
    PR_SYSTEM_PROMPT,
...
def create_pr_review_task(
    ...
    from infra.github_utils import slugify
