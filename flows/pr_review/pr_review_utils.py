...
def save_pr_review_locally(task_name: str, base_repo_files: dict, pr_data: dict, eval_info: dict):
    ...
    # ``flows/pr_review/pr_review_utils.py`` after Phase 2 — bumps up to repo root.
    base_dir = Path(__file__).parent.parent.parent / "data" / "generated" / "pr_review_tasks" / task_name
