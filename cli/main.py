...
Deploy / reset for live tasks live in ``infra.e2b/`` and are invoked via
``python -m infra.e2b deploy-task`` / ``reset-task``. Droplet deploys were
...
cli = click.Group(help="Utkrusht task-generation CLI (generate only — deploy lives in infra.e2b).")
