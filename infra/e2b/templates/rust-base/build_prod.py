...
# ``infra/e2b/manifest.py`` is four directories up from this file (which
# lives in ``infra/e2b/templates/rust-base/``). Add the repo root to sys.path
# so this script can be run directly with ``python build_prod.py``.
