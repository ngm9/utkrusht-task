...
# ``.parent.parent`` because this module lives at ``infra/utils.py`` after
# Phase 2 of the layout migration; bumps up to the repo root, then down into
# the curated / generated prompt trees.
_REPO_ROOT = _Path(__file__).parent.parent
_PROMPT_ROOT = _REPO_ROOT / "task_generation_prompts"
_AGENT_PROMPTS_ROOT = _REPO_ROOT / "data" / "generated" / "agent_prompts"
...
def save_files_locally(task_id: str, task_data: Dict) -> Path:
    ...
    try:
        ...
        local_task_dir = _REPO_ROOT / "data" / "generated" / "task_artifacts" / task_id
